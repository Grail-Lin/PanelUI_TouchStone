...
filelist = [
            ...
            "t1_output_20240704_bias250_30s_150_100_10_10_110_91_03_18_40uloil.txt"]
...
for f in filelist:
    ...
    ax1.hlines(temp_t2,0,400,color="red")
    ax1.hlines(temp_t3,0,400,color="red")
...
#    ax1.vlines(250,0,200,color="green")
    ...
    ax1.vlines(time_list[first_95], 0, temp_t1, color='red')
    ax2.vlines(time_list[first_95], 0, pwm_list[0], color='red')

    ax1.vlines(time_list[end_95], 0, temp_t1, color='red')
